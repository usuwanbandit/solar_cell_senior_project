...
create_new_material('InSb', 'data/InSb_n.txt', 'data/InSb_k.txt', 'data/InSb_params.txt')
...
plt.figure()
plt.plot(si(np.arange(300, 1700, 5), 'nm')*1e9, InSb.n(si(np.arange(300, 1700, 5), 'nm')))
plt.plot(si(np.arange(300, 1700, 5), 'nm')*1e9, InSb.k(si(np.arange(300, 1700, 5), 'nm')))
