    ...
    for i in dot_size:
        ...
        GaAs_junction = Junction([
                                 ...
                                 + [
                                     # Layer(width=si(f"100 nm"), material=AlGaAs, role="barrier"),
                                     # Layer(width=si("100 nm"), material=n_GaAs, role="Emitter"),
                                     Layer(width=si("1800 nm"), material=n_GaAs, role="Base"),
                                     Layer(width=si("100 nm"), material=n_GaInP, role="BSF"),
                                     Layer(width=si("150 nm"), material=n_GaAs_buffer, role="Buffer"),
                                 ],
                                 T=T, kind="PDD", substrate=n_GaAs_buffer)
        solarcell_InSb_GaSb = SolarCell([
            # Layer(width=si("100 nm"), material=MgF2, role="AR1"),
            # Layer(width=si("50 nm"), material=ZnS, role="AR2"),
            GaAs_junction,
    ...
    for i in dot_size:
        ...
        QW = PDD.QWunit(
            ...
            [
                ...
                # Layer(width=si(f"{2.5} nm"), material=InSb, role="well"),# TODO chack diff inter and barrier of this
                ...
                Layer(width=si(f"{10} nm"), material=i_GaAs, role="well"),  # 5-20 nm
...
def solar_cell_InSb_and_GaSb_like_paper():
    solar_each_size_1 = {}
    plot_note = dict(x_axis=[1, 2, 3], x_axis_name="DOT_VS_bulk", x_axis_txt="InSb&GaSb GaSb bulk")
