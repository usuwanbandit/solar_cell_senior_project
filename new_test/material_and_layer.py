...
# read this before sim
# list_something_to_sweep = [list...] -->  dot_size = np.linspace(0.5, 5, 5)
# plot_note = dict(x_axis= list_something_to_sweep , x_axis_name="name_for_list") --->  plot_note = dict(x_axis=dot_size, x_axis_name="InSb Dot size(nm)")
# dict_for_collect_data = {} --> solar_each_size_1 = {}
# for i in list_something_to_sweep:
#    material data --> n_GaAs = material('GaAs')(T=T, Nd=si('1e18 cm-3'), )
#    make QD --> QW = PDD.QWunit(
...
#                          ],
#                          T=T, kind="PDD", substrate=p_GaAs_buffer)
# make junction to solar cell
...
# return two for this to sim im main_function_for_simulation
...
#     for i in size_GaSbs:
#         size_InAs = 11
#         AlGaAs = material("AlGaAs")(T=T, Al=0.3, electron_mobility=si('300 cm2'))
#         n_GaAs = material('GaAs')(T=T, Nd=si('1e18 cm-3'), )
#         i_GaAs = material("GaAs")(T=T)
#         i_GaAs_barrier = material("GaAs")(T=T, strained=True, eff_mass_electron_Gamma=0.067
#                                           , eff_mass_hh_z=0.51
...
#              Layer(width=si("50 nm"), material=i_GaAs_barrier, role="barrier"),]
#
#             # +
#             # [Layer(width=si(f"100 nm"), material=AlGaAs, role="barrier")
#             #  ]
...
#         ]
#             , T=T, substrate=p_GaAs)
#         solar_each_size_1[f"size GaSb = {i} nm"] = solarcell_InAs_GaSb
#     return solar_each_size_1, plot_note
#
#
# # QDSC_InAs_GaSb()
...
#     return solar_each_size_1, plot_note
# upper this main_function_for_simulation don't support
# ===========================================================================================================
...
def QDSC_InAs_GaSb():
    solar_each_size_1 = {}
    SB_sweep = [0, 0.08, 0.14, 0.17]
    plot_note = dict(x_axis=SB_sweep, x_axis_name="GaAs$_{1-x}$Sb$_{x}$")

    for i in SB_sweep:
        size_InAs = 11
        size_GaSb = 15
        AlGaAs = material("AlGaAs")(T=T, Al=0.3, strained=True)
        n_GaAs_plus = material("GaAs")(T=T, Nd=si("2e18 cm-3"), )
        n_AlGaAs = material("AlGaAs")(T=T,Al=0.35, Nd=si("2e18 cm-3"), )
        n_GaAs = material('GaAs')(T=T, Nd=si('2e17 cm-3'), )
        i_GaAs = material("GaAs")(T=T)
        p_GaAs_min = material("GaAs")(T=T, Na=si("1e18 cm-3"), )
        p_GaAs = material("GaAs")(T=T, Na=si("5e18 cm-3"), )
        p_AlGaAs = material("AlGaAs")(T=T, Al=0.75, Nd=si("5e18 cm-3"))
        p_GaAs_plus = material("GaAs")(T=T, Na=si("1e20 cm-3"), )
        GaAsSb = material("GaAsSb")(T=T, Sb=i,)
        p_GaInP = material("GaInP")(T=T, In=0.42, Na=si("2e18 cm-3"))
        p_GaAs_buffer = material("GaAs")(T=T, Na=si("2e18 cm-3"))
        InSb = material("InSb")(T=T
                                , strained=True
        ...
        QW = PDD.QWunit([
                        Layer(width=si(f"45 nm"), material=i_GaAs, role="barrier"),]
                        +[
                         Layer(width=si(f"{11} nm"), material=InAs, role="well"),
                         Layer(width=si(f"{2} nm"), material=i_GaAs, role="interlayer"),
                         Layer(width=si(f"{15} nm"), material=GaSb, role="well"),  # 5-20 nm
                        ]* 20 # 5-20 nm
                        +[
                         Layer(width=si(f"{2} nm"), material=i_GaAs, role="interlayer"),
                         Layer(width=si(f"{5} nm"), material=GaAsSb, role="well"),  # 5-20 nm
        ]
                        +
                        [Layer(width=si(f"45 nm"), material=i_GaAs, role="barrier")
                         ], T=T, repeat=1, substrate=i_GaAs)
        QW_list = QW.GetEffectiveQW(wavelengths=wl, use_Adachi=True)
        GaAs_junction = Junction([
                                     Layer(width=si("30 nm"), material=p_AlGaAs, role="Emitter"),
                                     Layer(width=si("230 nm"), material=p_GaAs, role="Emitter"),
                                     Layer(width=si("100 nm"), material=p_GaAs_min, role="Emitter"),
                                 ]
                                 + QW_list
                                 + [
                                     # Layer(width=si("100 nm"), material=n_GaAs, role="Emitter"),
                                     Layer(width=si("1000 nm"), material=n_GaAs, role="Base"),
                                     Layer(width=si("50 nm"), material=n_AlGaAs, role="BSF"),
                                     Layer(width=si("200 nm"), material=n_GaAs_plus, role="Buffer"),
                                 ],
                                 T=T, kind="PDD", substrate=n_GaAs_plus)
        solarcell_InAs_GaSb = SolarCell([
            # Layer(width=si("100 nm"), material=MgF2, role="AR1"),
            # Layer(width=si("50 nm"), material=ZnS, role="AR2"),
            Layer(width=si("20 nm"), material=p_GaAs_plus, role="window"),
            GaAs_junction,
        ]
            , T=T, substrate=p_GaAs)
        solar_each_size_1[f"dot stack ={i}"] = solarcell_InAs_GaSb
    return solar_each_size_1 , plot_note
...
def QDSC_InSb_GaSb_sweep_InSb():
    ...
    for i in dot_size:
        ...
        InSb = material("InSb", sopra=True)(T=T
                                            ...
                                            , hole_minority_lifetime=si("1e-8 s")
                                            , relative_permittivity=13.943
                                            , electron_auger_recombination=si("1e-26 cm6")
                                            , hole_auger_recombination=si("1e-26 cm6")
                                            )
...
def QDSC_InSb_GaSb_sweep_InSb_pn():
    ...
    for i in dot_size:
        ...
        n_GaAs_inter = material('GaAs')(T=T, Nd=si('1e17 cm-3'), )
        n_AlGaAs = material("AlGaAs")(T=T, Al=0.3, Nd=si("5e16 cm-3"), strained=True)
        n_AlGaAs_window = material("AlGaAs")(T=T, Al=0.3, Nd=si("4e18 cm-3"))
        n_AlInP = material("AlInP")(T=T, Al=0.32, Nd=si('2e18 cm-3'))
        i_GaAs = material("GaAs")(T=T)
        i_GaAs_barrier = material("GaAs")(T=T, strained=True, )
        p_GaInP = material("GaInP")(T=T, In=0.42, Na=si("2e17 cm-3"))
        p_GaAs_buffer = material("GaAs")(T=T, Na=si("2e17 cm-3"))
        p_GaAs = material("GaAs")(T=T, Na=si("1e16 cm-3"), )
        InSb = material("InSb", sopra=True)(T=T
                                            , strained=True
                                            , valence_band_offset=si("0.0 eV")
                                            ...
                                            , radiative_recombination=si(f"5e-11 cm3") # add rad_coff
                                            )
...
def QDSC_InSb_GaSb_sweep_GaSb():#this struck work srh 1 rad 1 aug 0 sur 0 gen 1
    ...
    for i in dot_size:
        ...
        QW = PDD.QWunit(
            ...
            [
                ...
                Layer(width=si(f"{100 - i} nm"), material=i_GaAs, role="barrier"),
                Layer(width=si(f"{i} nm"), material=GaSb, role="well"),  # 5-20 nm
    ...
    for i in dot_size:
        ...
        QW = PDD.QWunit(
            ...
            [
                Layer(width=si(f"{100} nm"), material=i_GaAs, role="interlayer"),
                Layer(width=si(f"{size_InSb} nm"), material=InSb, role="well"),
                Layer(width=si(f"{100 - size_GaSb} nm"), material=i_GaAs, role="interlayer"),# TODO chack diff inter and barrier of this
                Layer(width=si(f"{size_GaSb} nm"), material=GaSb, role="well"),  # 5-20 nm
                Layer(width=si(f"{50} nm"), material=i_GaAs, role="barrier"),
            ]  # 5-20 nm
            # Layer(width=si("20 nm"), material=i_GaAs, role="barrier"),]*dot
...
def QDSC_InSb_GaSb_new_design():
    dot_size = np.linspace(0.5, 5, 50)
    plot_note = dict(x_axis=dot_size, x_axis_name="dot_size")
    solar_each_size_1 = {}
    ...
    for i in dot_size:
        ...
        p_AlGaAs = material("AlGaAs")(T=T, Al=0.3,  Na=si("1e16 cm-3"))
        i_GaAs = material("GaAs")(T=T)
        p_GaInP = material("GaInP")(T=T, In=0.42, Na=si("2e18 cm-3"))
        p_GaAs_buffer = material("GaAs")(T=T, Na=si("2e18 cm-3"))
        p_GaAs = material("GaAs")(T=T, Na=si("1e16 cm-3"), )
        ...
        # GaAsSb = material("GaAsSb")(T=T, strained=True, Sb=i,n=GaSb.n, k=GaSb.k,
        #                             electron_mobility=si("3e3 cm2"),
        #                             hole_mobility=si("1e3 cm2"),
        #                             )
        ...
        QW = PDD.QWunit(
            ...
            [
                ...
                # Layer(width=si(f"{15} nm"), material=i_GaAs, role="intelyer"),
                # Layer(width=si(f"{2.5} nm"), material=InSb, role="well"),
                Layer(width=si(f"{5} nm"), material=i_GaAs, role="well"),  # 5-20 nm
                # Layer(width=si(f"{i} nm"), material=InSb, role="well"),  # 5-20 nm
                # Layer(width=si(f"{100} nm"), material=i_GaAs, role="well"),
                Layer(width=si(f"{i} nm"), material=GaSb, role="well"),  # 5-20 nm
                # Layer(width=si(f"1 nm"), material=InSb_wet, role="well"),  # 5-20 nm

                # Layer(width=si(f"{30} nm"), material=AlGaAs, role="barrier"),
                Layer(width=si(f"{5} nm"), material=i_GaAs, role="well"),  # 5-20 nm
                # Layer(width=si(f"{5} nm"), material=GaSb, role="well"),  # 5-20 nm
                # Layer(width=si(f"{10} nm"), material=i_GaAs, role="well"),
                Layer(width=si(f"{15} nm"), material=AlGaAs, role="barrier"),
        ...
        solarcell_InSb_GaSb = SolarCell([
            ...
            , T=T, substrate=p_GaAs)
        solar_each_size_1[f"dot size = {i} "] = solarcell_InSb_GaSb
    return solar_each_size_1, plot_note
def QDSC_InSb_GaSb_sweep_stack_new_design_ver_1():
    ...
    for i in dot_size:
        ...
        AlGaAs = material("AlGaAs")(T=T, strained=True, Al=0.3)
        n_GaAs = material('GaAs')(T=T, Nd=si('1e16 cm-3'), )
        n_GaAs_window = material('GaAs')(T=T, Nd=si('1e19 cm-3'), )  # 1e16 work
        n_GaAs_inter = material('GaAs')(T=T, Nd=si('1e17 cm-3'), )
        n_AlGaAs = material("AlGaAs")(T=T, Al=0.3, Nd=si("5e17 cm-3"))
        p_AlGaAs = material("AlGaAs")(T=T, Al=0.3, Na=si("5e17 cm-3"))
        n_AlGaAs_window = material("AlGaAs")(T=T, Al=0.3, Nd=si("4e18 cm-3"))
        ...
        GaAs_junction = Junction([
                                 ...
                                 + QW_list
                                 + [
                                     Layer(width=si(f"100 nm"), material=p_AlGaAs, role="barrier"),
                                     # Layer(width=si(f"50 nm"), material=n_AlGaAs, role="barrier"),
                                     # Layer(width=si("50 nm"), material=n_GaAs, role="Emitter"),
                                     Layer(width=si("1800 nm"), material=p_GaAs, role="Base"),
                                     # Layer(width=si("100 nm"), material=p_GaInP, role="BSF"),
                                     # Layer(width=si("150 nm"), material=p_GaAs_buffer, role="Buffer"),
    ...
    for i in dot_size:
        ...
        QW = PDD.QWunit(
            ...
            [
                ...
                Layer(width=si(f"{i} nm"), material=InSb, role="well"),
                Layer(width=si(f"{2} nm"), material=i_GaAs, role="well"),
                Layer(width=si(f"{15} nm"), material=AlGaAs, role="well"),
                Layer(width=si(f"{2} nm"), material=i_GaAs, role="interlayer"),
                Layer(width=si(f"{16} nm"), material=GaSb, role="well"),  # 5-20 nm
                Layer(width=si(f"{2} nm"), material=i_GaAs, role="interlayer"),
                Layer(width=si(f"{15} nm"), material=AlGaAs, role="barrier"),
...
def QDSC_InSb_GaSb_sweep_InSb_new_design_ver_1_0D():
    con = np.logspace(0, 3, 5)
    plot_note = dict(x_axis=con, x_axis_name="Light concentration (sun)")
    ...
    p_AlGaAs = material("AlGaAs")(T=T, Al=0.3, Na=si("5e17 cm-3"), strained=True)
    n_AlGaAs_window = material("AlGaAs")(T=T, Al=0.3, Nd=si("4e18 cm-3"))
    n_AlInP = material("AlInP")(T=T, Al=0.32, Nd=si('3e18 cm-3'))
    i_GaAs = material("GaAs")(T=T)
    i_GaAs_barrier = material("GaAs")(T=T, strained=True, )
    ...
    solarcell_InSb_GaSb = SolarCell([
        ...
        , T=T, substrate=p_GaAs)
    return solarcell_InSb_GaSb, plot_note

#WORK
def QDSC_GaSb_InSb_sweep_stack_swap():
    dot_size = np.arange(1, 11, 1)
    plot_note = dict(x_axis=dot_size, x_axis_name="stack")
    solar_each_size_1 = {}
...
#WORK
def QDSC_InSb_GaSb_sweep_InSb_AlGaAs(): #work
    dot_size = np.linspace(0.5, 5, 50)
    plot_note = dict(x_axis=dot_size, x_axis_name="InSb Dot size(nm)")
    solar_each_size_1 = {}
...
#WPRL
def QDSC_InSb_GaSb_sweep_stack_AlGaAs(): #work
    dot_stack = np.arange(1, 5, 1)
    plot_note = dict(x_axis=dot_stack, x_axis_name="stack of QD")
    solar_each_size_1 = {}
    ...
    for i in dot_stack:
        ...
        QW = PDD.QWunit(
            ...
            [
                Layer(width=si(f"{100} nm"), material=i_GaAs, role="interlayer"),
                Layer(width=si(f"{size_InSb} nm"), material=InSb, role="well"),
                Layer(width=si(f"{100-size_GaSb} nm"), material=i_GaAs, role="well"),
                Layer(width=si(f"{size_GaSb} nm"), material=GaSb, role="well"),  # 5-20 nm
            ]*i   # 5-20 nm
            # Layer(width=si("20 nm"), material=i_GaAs, role="barrier"),]*dot
            ...
            +
            [
                Layer(width=si(f"{50} nm"), material=n_GaAs_bot, role="interlayer"),
                Layer(width=si(f"100 nm"), material=AlGaAs, role="barrier")]
            , T=T, repeat=1, substrate=i_GaAs)
        ...
        GaAs_junction = Junction([
                                 ...
                                 + [
                                     Layer(width=si(f"100 nm"), material=n_AlGaAs, role="barrier"),
                                     Layer(width=si(f"100 nm"), material=n_GaAs_bot, role="barrier"),
...
def QDSC_InSb_GaSb_sweep_stack_AlGaAs_swap(): #work
    dot_size = np.arange(1, 11, 1)
    plot_note = dict(x_axis=dot_size, x_axis_name="stack")
    solar_each_size_1 = {}
    ...
    for i in dot_size:
        ...
        QW = PDD.QWunit(
            ...
            # Layer(width=si("20 nm"), material=i_GaAs, role="barrier"),]*i
            #
            +
            [
                Layer(width=si(f"{50} nm"), material=i_GaAs, role="barrier"),
...
def QDSC_InSb_GaSb_sweep_InSb_AlGaAs_n_type(): #WORK
    ...
    dot_size = [1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5]
    plot_note = dict(x_axis=dot_size, x_axis_name="InSb Dot size(nm)")
    solar_each_size_1 = {}
...
def QDSC_InSb_GaSb_sweep_stack_AlGaAs_n_type(): #WORK
    dot_stack = np.arange(1, 10, 1)
    plot_note = dict(x_axis= dot_stack, x_axis_name="dot stack")
    solar_each_size_1 = {}
    for i in dot_stack:
        size_GaSb = 16
        AlGaAs = material("AlGaAs")(T=T, Al=0.3)
...
def QDSC_InSb_GaSb_sweep_stack_AlGaAs_n_type_0D(): #WORK
    con = np.logspace(1, 3, 5)
    plot_note = dict(x_axis=con, x_axis_name="Light concentration (sun)")
    size_GaSb = 16
    n_AlGaAs = material("AlGaAs")(T=T, Al=0.3, Nd=si("1e16 cm-3"))
    n_GaAs = material('GaAs')(T=T, Nd=si('1e18 cm-3'), )
    ...
    InSb = material("InSb")(T=T
                            ...
                            , electron_auger_recombination=si("1e-42 cm6")
                            , hole_auger_recombination=si("1e-42 cm6")
                            # , radiative_recombination=2.8744203894058427e-18
                            )
    # GaSb = material("GaSb")(T=T, strained=True, hole_mobility=0.09, electron_mobility=0.48)
    GaSb = material("GaSb")(T=T, strained=True,
                            electron_mobility=si("3e3 cm2"),
...
def QDSC_InSb_GaSb_sweep_stack_AlGaAs_n_type_new_design(): #WORK
    dot_stack = np.arange(1, 11, 1)
    plot_note = dict(x_axis=dot_stack, x_axis_name="dot stack")
    solar_each_size_1 = {}
    ...
    for i in dot_stack:
        ...
        # QW_list = QW.GetEffectiveQW(wavelengths=wl, use_Adachi=True)
        GaAs_junction = Junction([
                                     Layer(width=si("50 nm"), material=n_GaAs, role="window"),
                                     Layer(width=si(f"100 nm"), material=n_AlGaAs, role="barrier"),
                                     Layer(width=si(f"{50} nm"), material=i_GaAs, role="barrier"),
                                 ]
                                 + QW_list
                                 + [
                                     Layer(width=si(f"50 nm"), material=n_GaAs, role="Emitter"),

                                     Layer(width=si(f"100 nm"), material=n_AlGaAs, role="barrier"),
                                     Layer(width=si(f"100 nm"), material=n_GaAs, role="Emitter"),
...
def QDSC_InSb_GaSb_sweep_InSb_AlGaAs_n_type_swap():
    ...
    for i in dot_size:
        ...
        AlGaAs = material("AlGaAs")(T=T, Al=0.3)
        n_AlGaAs = material("AlGaAs")(T=T, Al=0.3, Nd=si("1e17 cm-3"))
        n_AlGaAs_bot = material("AlGaAs")(T=T, Al=0.3, Nd=si("1e15 cm-3"))
        n_GaAs = material('GaAs')(T=T, Nd=si('1e19 cm-3'), )
        n_GaAs_bot = material('GaAs')(T=T, Nd=si('1e15 cm-3'), )
        ...
        GaAs_junction = Junction([
                                 ...
                                 + QW_list
                                 + [
                                     Layer(width=si(f"100 nm"), material=n_AlGaAs_bot, role="barrier"),
                                     Layer(width=si(f"100 nm"), material=n_GaAs_bot, role="barrier"),
...
def solar_cell_InSb_and_GaSb_like_paper():
    solar_each_size_1 = {}
    plot_note = dict(x_axis=[1, 2], x_axis_name="DOT_VS_bulk", x_axis_txt="InSb&GaSb bulk")
    ...
    def get_GaSb_InSb():
        ...
        n_GaAs_inter = material('GaAs')(T=T, Nd=si('1e17 cm-3'), )
        n_AlGaAs = material("AlGaAs")(T=T, Al=0.3, strained=True, Nd=si("1e16 cm-3"))
        i_GaAs = material("GaAs")(T=T)
        p_GaInP = material("GaInP")(T=T, In=0.42, Na=si("2e18 cm-3"))
        p_GaAs_buffer = material("GaAs")(T=T, Na=si("2e18 cm-3"))
        p_GaAs = material("GaAs")(T=T, Na=si("1e16 cm-3"), )
    ...
    def get_GaSb():
        ...
        QW = PDD.QWunit(
            [
                ...
                Layer(width=si("10 nm"), material=i_GaAs_strain_free, role="interlayer"),
                Layer(width=si(f"{size_GaSb} nm"), material=GaSb, role="well"),  # 5-20 nm
                Layer(width=si("10 nm"), material=i_GaAs_strain_free, role="interlayer"),
                Layer(width=si("15 nm"), material=AlGaAs, role="barrier"),

            ]  # 5-20 nm
            , T=T, repeat=10, substrate=i_GaAs_strain_free)
        QW_list = QW.GetEffectiveQW(wavelengths=wl, use_Adachi=True)
        GaAs_junction = Junction([
                                     Layer(width=si("300 nm"), material=n_GaAs, role="Emitter"), ]
                                 + QW_list
                                 + QW_list
                                 + [
                                     Layer(width=si("500 nm"), material=p_GaAs, role="Base"),
                                 ],
                                 T=T, kind="PDD", substrate=p_GaAs, sn=0, sp=0)
    ...
    def get_GaAs():
        ...
        GaAs_junction = Junction([
                                     Layer(width=si("300 nm"), material=n_GaAs_window, role="Emitter"),
                                     Layer(width=si("100 nm"), material=n_GaAs, role="Emitter"),
                                     # Layer(width=si("100 nm"), material=n_GaAs, role="Emitter"),
                                     Layer(width=si("1800 nm"), material=p_GaAs, role="Base"),
                                     # Layer(width=si("100 nm"), material=p_GaInP, role="BSF"),
...
if __name__ == '__main__':
    ...
    print(GaSb.valence_band_offset)
    print(asUnit(GaSb.valence_band_offset, 'eV'))
    print('-----------------------------------------')
    print('eff_mass_electron')
    print(GaSb.eff_mass_electron)
    print('-----------------------------------------')
    print('eff_mass_electron_Gamma')
    print(GaSb.eff_mass_electron_Gamma)
    print('-----------------------------------------')
    print('electron_mobility')
    print(GaSb.electron_mobility)
    print('-----------------------------------------')
    print('hole_mobility')
    print(GaSb.hole_mobility)
    print('-----------------------------------------')
    print('eff_mass_hh_z')
    print(GaSb.eff_mass_hh_z)
    print('-----------------------------------------')
    print('eff_mass_lh_z')
    print(GaSb.eff_mass_lh_z)
    print('-----------------------------------------')
    print('electron_affinity')
    print(GaSb.electron_affinity)
    print(asUnit(GaSb.electron_affinity, 'eV'))
    print('-----------------------------------------')
    print('gamma1')
    print(GaSb.gamma1)
    print('-----------------------------------------')
    ...
    print('a_c')
    print(GaSb.a_c)
    print(asUnit(GaSb.a_c, 'eV'))
    print('-----------------------------------------')
    print('a_v')
    print(GaSb.a_v)
    print(asUnit(GaSb.a_v, 'eV'))
    print('-----------------------------------------')
    print('b')
    print(GaSb.b)
    print(asUnit(GaSb.b, 'eV'))
    print('-----------------------------------------')
    print('d')
    print(GaSb.d)
    print(asUnit(GaSb.d, 'eV'))
    print('-----------------------------------------')
    print('c11')
    print(GaSb.c11)
    print(asUnit(GaSb.c11, 'GPa'))

    print('-----------------------------------------')
    print('c12')
    print(GaSb.c12)
    print(asUnit(GaSb.c12, 'GPa'))
    print('-----------------------------------------')
    print('c44')
    print(GaSb.c44)
    print(asUnit(GaSb.c44, 'GPa'))
    print('-----------------------------------------')
    print('interband_matrix_element')
    print(GaSb.interband_matrix_element)
    print(asUnit(GaSb.interband_matrix_element, 'eV'))
    print('-----------------------------------------')
    print('spin_orbit_splitting')
    print(GaSb.spin_orbit_splitting)
    print(asUnit(GaSb.spin_orbit_splitting, 'eV'))
    ...
    print(GaSb.relative_permittivity)
    print('-----------------------------------------')
    print("electron_minority_lifetime")
    print(GaSb.electron_minority_lifetime)
    print('-----------------------------------------')
    print("hole_minority_lifetime")
    print(GaSb.hole_minority_lifetime)
    print('-----------------------------------------')

    # print('electron_auger_recombination')
    # print(GaSb.electron_auger_recombination)
    # print('-----------------------------------------')
    # print('hole_auger_recombination')
    # print(GaSb.hole_auger_recombination)
    # print('-----------------------------------------')
    # # struc = Structure([
    # #     # Layer(width=si(f"10 nm"), material=AlGaAs, role="barrier"),
